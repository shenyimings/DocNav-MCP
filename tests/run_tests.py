...
"""
        ...
        try:
            ...
            for i in range(1, 21):  # 20 main sections
                ...
                for j in range(1, 6):  # 5 subsections each
                    ...
                    large_content += (
                        f"Content for subsection {i}.{j} with some searchable text.\n"
                    )
                    large_content += (
                        "Additional paragraph with more content to search.\n\n"
                    )
    ...
    def test_edge_cases(self):
        ...
        try:
            ...
            headings = [
                n for n in heading_compass.index.values() if n.type == "heading"
            ]
            ...
            paragraphs = [
                n for n in plain_compass.index.values() if n.type == "paragraph"
            ]
            ...
            headings = [
                n for n in malformed_compass.index.values() if n.type == "heading"
            ]
            ...
            deep_headings = [
                n for n in deep_compass.index.values() if n.type == "heading"
            ]
            # Markdown only supports 6 levels of headings (H1-H6)
            # The 7th level should be treated as regular text
            assert len(deep_headings) == 6
...
"""
    ...
    def generate_report(self):
        ...
        if self.results["failed"] == 0:
            ...
            print(
                f"❌ {self.results['failed']} test(s) failed. Please review the errors above."
            )
